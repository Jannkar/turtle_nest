...
bool PackagesWindow::create_new_workspace(QString new_workspace_path){
    ...
    reply = QMessageBox::question(this, "Create Folder",
    ...
    if (reply == QMessageBox::Yes) {
        ...
        if (!dir.mkpath(new_workspace_path)) {
            QMessageBox::critical(this, "Error", "Failed to create folder! Is the path valid and do you have sufficient permissions?");
            return false;
        }
    }
    else{
